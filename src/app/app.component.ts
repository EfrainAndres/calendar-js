  ...
  ngOnInit(): void {
    var cal = {
      ...
      list: function () {
        ...
        cal.sMth = parseInt((<HTMLInputElement>document.getElementById("cal-mth")).value); // selected month
        cal.sYear = parseInt((<HTMLInputElement>document.getElementById("cal-yr")).value); // selected year
      ...
      show: function (el) {
        ...
        tForm += "<input id='closeInput' type='button' value='Close'/>";
        tForm += "<input type='button' data-toggle='modal' data-target='#exampleModal' value='Eliminar'/>";
        ...
        closeInput.onclick = cal.close;

        var deleteInput = document.getElementById("hola");
        deleteInput.onclick = cal.del;
      },
      ...
      save: function (evt) {
        evt.stopPropagation();
        evt.preventDefault();
        cal.data[cal.sDay] = (<HTMLInputElement>document.getElementById("evt-details")).value;
